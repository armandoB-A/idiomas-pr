...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" src="assets/Imagen.png" />
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand"> FROM YOU</a>
    ...
    <div class="copyright py-4 text-center text-white">
        <div class="container"><small>certificados &copy; para tu sitio web 2023</small></div>
    </div>
    <!-- Bootstrap core JS-->
